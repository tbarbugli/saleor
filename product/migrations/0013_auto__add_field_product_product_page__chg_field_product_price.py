...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.product_page'
        db.add_column(u'product_product', 'product_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Product.price'
        db.alter_column(u'product_product', 'price', self.gf('django_prices.models.PriceField')(currency='EUR', max_digits=12, decimal_places=4))

    def backwards(self, orm):
        # Deleting field 'Product.product_page'
        db.delete_column(u'product_product', 'product_page_id')


        # Changing field 'Product.price'
        db.alter_column(u'product_product', 'price', self.gf('django_prices.models.PriceField')(currency='USD', max_digits=12, decimal_places=4))
