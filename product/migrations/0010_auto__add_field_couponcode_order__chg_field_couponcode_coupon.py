...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CouponCode.order'
        db.add_column(u'product_couponcode', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'CouponCode.coupon'
        db.alter_column(u'product_couponcode', 'coupon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Coupon'], null=True))

    def backwards(self, orm):
        # Deleting field 'CouponCode.order'
        db.delete_column(u'product_couponcode', 'order_id')


        # User chose to not deal with backwards NULL issues for 'CouponCode.coupon'
        raise RuntimeError("Cannot reverse this migration. 'CouponCode.coupon' and its values cannot be restored.")
    ...
    models = {
        ...
        u'product.couponcode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'bgCBgrW926RCgtt'", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
